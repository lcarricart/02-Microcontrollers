...
-- insert your machine code here
    ("0000100010000011"),           -- sub r3, r1, r0 (r3 = 1 - 56)
    ("0001100010000100"),           -- and r4, r1, r0
    ("0001000010000101"),           -- xor r5, r1, r0
    ("0010000000000110"),           -- shl r6, r0 (r6 = 56 << 1)

-- Task 2
    ("1010000000010111"), --load from SW0
    ("0010000111000111"), --shl r7 r7
    ("1110000000000111"), -- store in LED0
