...
{
    static const char *topics[] = {"python/mqtt", "lwip_other/#"};
    int qos[]                   = {0, 1};
    err_t err;
    int i;
...
{
    static const char *topic   = "python/mqtt";
    static const char *message = "Rocking it here!!";
...
#if FEAT_WAIT_FOR_PETER
    PRINTF("Waiting for Peter...\r\n");
    while(1) {
